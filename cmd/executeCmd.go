...
var execute = &cobra.Command{
	Use:   "execute",
	Short: "ADMIN USE ONLY - HIGHLY RISKY. Execute scripts inside any folder",
	Long: `Execute scripts inside any folder. For example:

	db2ctl execute folder-name [folder-name ...]

	After you setup auto-completion, pressing [tab][tab] will show all possible options.
	
	Please note, this is HIGHLY RISKY and for ADMIN USE ONLY.`,
